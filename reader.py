...
def counts():
    ...
    directories = ['cnn/questions/training/',
                   'cnn/questions/validation/', 'cnn/questions/test/']
    files = [
        directory + file_name
...
def tokenize(index, word):
    ...
    for directory in directories:
        ...
        files = map(lambda file_name: directory +
...
def main():
    ...
    # tokenize(index, word)
    reverse_index = {i: t for t, i in index.items()}
    with open('reverse_index.pickle', 'wb') as f:
